...
set rc [catch {
  ...
  set_property ip_repo_paths d:/vivado/number_guess/number_guess.cache/ip [current_project]
  set_property ip_output_repo d:/vivado/number_guess/number_guess.cache/ip [current_project]
  add_files -quiet D:/vivado/number_guess/number_guess.runs/synth_1/top.dcp
